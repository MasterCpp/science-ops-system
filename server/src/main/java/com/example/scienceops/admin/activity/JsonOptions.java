...
final class JsonOptions {
    ...
    static String stringify(List<String> options) {
        try {
            return OBJECT_MAPPER.writeValueAsString(options == null ? List.of() : options);
        } catch (Exception exception) {
            throw new IllegalArgumentException("Invalid options", exception);
        }
    }
